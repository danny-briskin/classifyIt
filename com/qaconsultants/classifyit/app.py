...
import typing
from flask import Flask, escape, request, jsonify, logging, make_response
...
def text():
    ...
    if request.method == 'POST':
        ...
        # app.logger.info('%s Response', req)
        request_data = RequestData(req['image_url'], req['image_texts'])
        ...
        response_body = process(request_data.image_texts)
...
def process(initial_categories_list: typing.List[str]):
    ...
    for file_image in list_of_images:
        ...
        return json_probabilities(initial_categories_list, preprocessed_probabilities)


def print_probabilities(initial_texts_list: typing.List[str],
...
def json_probabilities(initial_texts_list: typing.List[str],
                       preprocessed_probabilities: typing.List[
